...
*
* @param {string} studentName the name of the student to get grades for. This should be the exact name
* of the student from the "Teams" sheet.
...
/**
* Gets the student asurites from the sheet attached to this script and returns it as a 2-dimensional array.
* Imagine this as 1 column where each row is a student name.
*
* @returns {string[][]} the range of cells containing the student asurite values from the attached sheet
**/
...
/**
* Maps the form IDs of the grading question and comment question to each student ID given the properly filled
* studentsObj. The studentsObj must have the fullName assigned for this to work properly. 
* 
...
function getFormIdMaps(studentsObj) {
  ...
  **/
  ...
  // Maps the form IDs to student IDs (so it reverses the relation, and adds in the actual ASURite IDs)
  const formIdsMaps = {
    gradingFormItemIds: {},
    commentFormItemIds: {}
  };
